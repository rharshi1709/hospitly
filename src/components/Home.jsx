...
function Home() {
  ...
  <div className="">
    ...
    <div className='mt-8'>
      <a href='/appointment' className='bg-transparent border-[#798086] border-2 text-[#ffffff] rounded-xl py-2 font-bold p-1 px-2 m-3'>
        Book an Appointment
      </a>
      <a href='/doctors' className='bg-[#3d4146] px-2 rounded-xl text-[#ffffff] py-2  font-bold  p-1 m-3'>
        Find a Doctor
      </a>
    </div>
  </div>
